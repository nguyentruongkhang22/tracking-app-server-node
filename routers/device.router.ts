...
router.route('/:id').get(verifyToken, getDevice).put(updateDevice).patch(updateDevice);
router.route('/:id/tvr').get(verifyToken, getTimeVariantData).patch(updateTimeVariantData);
